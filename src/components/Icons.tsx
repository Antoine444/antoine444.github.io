...
/**
 * Icons are inline and inherit `currentColor`, so they work in both themes.
 * The originals shipped with `fill="white"` baked in and vanished on a light
 * background; that is why they are re-authored here rather than imported.
 */
...
export const LinkedInIcon = (p: IconProps) => (
    <svg viewBox="0 0 382 382" fill="currentColor" {...base(p)}>
...
export const HuggingFaceIcon = (p: IconProps) => (
    <svg viewBox="0 0 24 24" fill="currentColor" {...base(p)}>
