    ...
    return (
        <section id="projects" className="py-20 bg-background">
            <div className="container mx-auto px-6">
                ...
                {/* Wrap all cards in CardContainer for persistent animations */}
                <CardContainer>
                    {/* Projects Grid */}
                    <div className="grid md:grid-cols-2 gap-8">
                        {projects.map((project, index) => (
                            <Card
                                key={index}
                                id={`project-${index}`} // Add unique ID for each project card
                                title={project.title}
                ...
                <CardContainer>
                    <div className="mt-16 text-center">
                        <Card
                            id="more-projects" // Add unique ID for the "coming soon" card
